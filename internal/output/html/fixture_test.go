...
func TestReferenceDeckBuildFlow(t *testing.T) {
	...
	for _, needle := range []string{"scroll-snap-type: x mandatory", "@page", "size: 13.333in 7.5in", "display: block !important", "break-after: page"} {
